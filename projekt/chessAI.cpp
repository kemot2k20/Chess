...
namespace {
    ...
    inline int PCOLOR(int x) { return x >= 6; }

    inline int inZone(int sq1, int sq2) {
...
{
    init_tables(); // Inicjalizuje tablice dla konkretnej instancji AI
}
...
int AI::utility(Board board, Color turn) {
    ...
    for (int sq = 0; sq < 64; ++sq) {
        ...
        if (pc <= 11) { // 12 jest puste
            ...
            // Korzystamy z wewnętrznych tablic obiektu AI
